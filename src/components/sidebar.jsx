          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://www.linkedin.com/in/fin-elliott-629206b9/" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
                <li><a href="https://github.com/griffinrobertelliott" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
            ...
            <div className="colorlib-footer">
              <p><small>
                  ...
                  Thanks <a href="https://github.com/dbarochiya" target="_blank" rel="noopener noreferrer">Dhruv</a> for the inspiration!
              </small></p>
              {/* <p><small>
